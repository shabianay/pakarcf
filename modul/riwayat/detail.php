...
if (isset($_GET['id'])) {
  ...
  if ($sqlhasil && mysqli_num_rows($sqlhasil) > 0) {
    ...
    // <button id='print' onClick='window.print();' data-toggle='tooltip' data-placement='right' title='Klik tombol ini untuk mencetak hasil diagnosa'><i class='fa fa-print'></i> Cetak</button>
