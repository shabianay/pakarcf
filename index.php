...
<body id="pakar" class="hold-transition skin-purple-light sidebar-mini">
  <div class="wrapper">
    <!-- Main Header -->
    <header class="main-header">
      ...
      <a href="./" class="logo">
        ...
        <span class="logo-mini"><b>P.CF</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>PAKARCF</b></span>
      </a>
      <!-- Header Navbar -->
    ...
    <footer class="main-footer">
      ...
      <strong>
        <div class="cinta">Copyright © 2024</div>
      </strong>
    </footer>
